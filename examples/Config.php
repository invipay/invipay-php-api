...
if (false) // Change to true if you want partner platform mode
{
	define('INVIPAY_PARTNER_API_KEY', '00000000-0000-0000-0000-000000000003');
	define('INVIPAY_PARTNER_SIGNATURE_KEY', '00000000-0000-0000-0000-000000000004');
}
else
{
